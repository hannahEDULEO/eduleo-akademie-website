...
async function handleTermine(url) {
  ...
  const simplyUrl = eventId ? `https://eduleo-akademie.simplyorg-seminare.de/event-details?event_id=${eventId}` : `https://eduleo-akademie.simplyorg-seminare.de/qualification-details?qualification_id=${qualId}`;
  try {
